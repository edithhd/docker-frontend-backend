...
SVC_NAME="actions.runner.edithhd-docker-frontend-backend.laptop-runner-2.service"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (edithhd-docker-frontend-backend.laptop-runner-2)"
